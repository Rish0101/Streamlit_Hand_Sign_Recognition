            ...
            if len(hands) == 1:
                ...
                if distance < join_distance_threshold:
                    ...
                    try:
                        ...
                        confidence_two_handed[index] = find_max(prediction, 0, len(prediction) - 1)
                    ...
                    try:
                        ...
                        confidence_one_handed[index1] = find_max(prediction1, 0, len(prediction1) - 1)
                    ...
                    try:
                        ...
                        confidence_one_handed[index2] = find_max(prediction2, 0, len(prediction2) - 1)
